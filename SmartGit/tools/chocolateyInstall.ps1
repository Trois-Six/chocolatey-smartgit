...
$packageName = 'SmartGit' # arbitrary name for the package, used in messages
$installerType = 'exe' #only one of these two: exe or msi
$url = 'http://www.syntevo.com/download/smartgithg/smartgithg-win32-setup-nojre-4_0_5.zip' # download url
